...
if OHAI.kernel['machine'] =~ /x86_64/
  ...
  source :url => "http://download.oracle.com/otn-pub/java/jdk/7u3-b04/jre-7u51-linux-x64.tar.gz",
  ...
  source :url => "http://download.oracle.com/otn-pub/java/jdk/7u3-b04/jre-7u51-linux-i586.tar.gz",
